...
<div class="row">
  <div class="col-sm-12">
  <?php
    $friendly_title = '<h2>' . $this->t('{themeopenaire:userid_error:friendly_title}') . ' ' . $this->data['parameters']['%IDP%'] . '</h2>';
    echo $friendly_title;
  ?>
    <p><?php echo $this->t('{themeopenaire:userid_error:friendly_description}'); ?></p>
...
<div class="row">
  <div class="col-sm-12">
    <h2><?php echo $this->t('{themeopenaire:userid_error:contact_title}'); ?></h2>
    <p><?php echo $this->t('{themeopenaire:userid_error:contact_description}'); ?></p>
  </div>
</div>
<?php
